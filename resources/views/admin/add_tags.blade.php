...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>  {{ isset($edit) ? 'Edit Tag' : 'Add Tag' }}</h2>
        <ol class="breadcrumb">
            <li>
                <a href="#">Home</a>
            </li>
            ...
            <li class="active">
                <strong> {{ isset($edit) ? 'Edit Tag' : 'Add Tag' }}</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form action="{{ isset($edit) ? '/admin/tags/update/'.$edit->id : '/admin/tags/store' }}" method="POST" class="form-horizontal">
                            @csrf
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <button class="btn btn-primary" type="submit">{{ isset($edit) ? 'Update' :    'Add Tag' }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
