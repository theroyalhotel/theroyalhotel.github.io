...
<head>
    ...
    <title>The Royal | Contacts</title>
    <style>
    /* -------------------------------------
    GLOBAL
        ...
        <td class="container" width="600">
            <div class="content">
                ...
                <div class="footer">
                    <table width="100%">
                        <tr>
                            <td class="aligncenter content-block">Follow <a href="#">@Company</a> on Facebook.</td>
                        </tr>
                    </table>
                </div></div>
        </td>
