...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>{{ isset($edit) ? 'Edit blog' : 'Edit Room' }}</h2>
            <ol class="breadcrumb">
                <li>
                    <a href=".home">Home</a>
                </li>
                ...
                <li class="active">
                    <strong>{{ isset($edit) ? 'Edit blog' : 'Edit Room' }}</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                    ...
                    @foreach($rooms as $room)
                        <form method="POST">
                            ...
                            <div class="form-group"> <label class="col-sm-2 control-label">Detail</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="detail" id="detail" required>{{$room->detail}}</textarea>
                                </div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label">Avatar</label>
                                <img src="source/images/avatar_room/{{$room->avatar_room}}" width="200px" height="200px" style="margin:10px 0px 0px 15px">
                            </div>

                            <label class="col-sm-2 control-label"></label>
                            <div class="col-sm-10"> <input type="file" name="avatar_room"><br>
                            </div>
                            <div>
