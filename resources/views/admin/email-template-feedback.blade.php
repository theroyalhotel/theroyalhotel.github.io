                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-block">
                                        <h2>Cảm ơn bạn đã sử dụng và tin tưởng chúng tôi!</h2>
                                        <h4> Để cải thiện dịch vụ tốt hơn bạn hãy điền những cảm nhận của mình trên đường <a href="http://wd13303.test/feedback/{{$urlactive1}}/{{$urlactive2}}">link</a> sau! </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                    <a class="buttonsm" href="http://wd13303.test/feedback/{{$urlactive1}}/{{$urlactive2}}">Feedback Now</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
