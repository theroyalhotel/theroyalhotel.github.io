                ...
                <div class="ibox-content">
                    <table class="footable table table-stripped toggle-arrow-tiny">
                        ...
                        <tbody>
                            ...
                            @if(isset($blogs_waiting))
                                @foreach($blogs_waiting as $blog)
                                <tr>
                                    <td>{{$id++}}</td>
                                    <td>{{$blog->name}}</td>
                                    ...
                                    <td> <button type="button" data-toggle="modal" data-target="#exampleModal1{{$blog->id}}"
                                            class="btn btn-info btn-sm">Approved</button></td>
                                ...
                                <div class="modal fade" id="exampleModal1{{$blog->id}}" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog mt-5" role="document" style="width:30%">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                Are you approved this post?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" data-dismiss="modal">Hmmmm,
                                                    wait!</button>
                                                <a type="button" class="btn btn-danger"
                                                    href="/admin/blogs/approved/{{$blog->id}}">Sure!!!</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if($blogs_waiting)
                                <td colspan="8">
                                    <ul class="pagination pull-right">
                                          {{ $blogs_waiting->links('vendor.pagination.bootstrap-4') }}
                                    </ul>
                                </td>
                                @endif
                            </tr>
