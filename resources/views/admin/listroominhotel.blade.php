                    ...
                    <div class="ibox-content">
                        <table class="footable table table-stripped toggle-arrow-tiny">
                            ...
                            <div style="display:none">{{$id=1}}</div>
                                @foreach($listroominhotel as $room)
                                    <tr>
                                        <td>{{$room->no_room}}</td>
                                        <td>{{$room->price}}</td>
                                        ...
                                        <td><span class="pie">
                                            @if(($room->status)==0)
                                            <span class="label label-primary">FREE</span></span>
                                            @endif
                                            @if(($room->status)==1)
                                            <span class="label label-success">WAITTING</span>
                                            @endif
                                            @if(($room->status)==2)
                                            <span class="label label-warning">EXISTING</span>
                                            @endif
                                        </td>
                            ...
                            <div class="row">{{$listroominhotel->links()}}</div>
                    </div>
                </div>
            </div>
        </div>
