                        ...
                        <table class="footable table table-stripped toggle-arrow-tiny">
                            ...
                            <div style="display:none">{{$id=1}}</div>
                                @foreach($orderdetail as $order)
                                    <tr>
                                        <td><span class="pie">{{$order->no_room}}</span></td>
                                        <td><span class="pie">{{$order->no_slot}}</span></td>
                                        <td><span class="pie">{{$order->no_bed}}</span></td>
                                        <td><span class="pie">{{$order->price}}</span></td>
                                    </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
                            ...
                            <div class="row">{{$orderdetail->links()}}</div>
                    </div>
                </div>
            </div>
        </div>
